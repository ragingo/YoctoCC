...
inline constexpr Instruction<JS> js;
inline constexpr Instruction<TEST> test;
...
inline constexpr Instruction<XORPS> xorps;
inline constexpr Instruction<XORPD> xorpd;
inline constexpr Instruction<ADDSS> addss;
inline constexpr Instruction<ADDSD> addsd;
inline constexpr Instruction<SUBSS> subss;
inline constexpr Instruction<SUBSD> subsd;
inline constexpr Instruction<MULSS> mulss;
inline constexpr Instruction<MULSD> mulsd;
inline constexpr Instruction<DIVSS> divss;
inline constexpr Instruction<DIVSD> divsd;
